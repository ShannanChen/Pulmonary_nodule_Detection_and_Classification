...
% Meta parameters
net.meta.inputSize = [net.meta.normalization.imageSize, 8] ;%32
...
% net = add_block(net, opts, '8', 1, 1, 4096, 2, 1, 0) ;  %%%%%%%%%%%%%%%%%net = add_block(net, opts, '8', 1, 1, 4096, 1000, 1, 0) ; 
% net.layers(end) = [] ;
% if opts.batchNormalization, net.layers(end) = [] ; end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%change
net=load('/home/cad/zyc/chengxu/matconvnet-1.0-beta22bcn/examples/imagenet/imagenet-matconvnet-alex.mat');
net.layers(18).block.size=[1,1,4096,2];
net.params(15).value = 0.001*randn(1,1,4096,2,'single');     %%%%%%改动1119   源0.001改为0.005效果平稳
net.params(16).value = 0.001*randn(2,1,'single');
%  net.layers(19).type = 'dagnn.softmaxloss' ;
