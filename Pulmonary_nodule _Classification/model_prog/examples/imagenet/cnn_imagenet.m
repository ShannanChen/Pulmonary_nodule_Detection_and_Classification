...
opts.dataDir = '/home/cad/zyc/shuju/1219/output/zrgb/2倍交叉验证/1/all/';%fullfile(vl_rootnn, 'data','ILSVRC2012') ;
...
opts.expDir = fullfile(vl_rootnn, 'data', ['img-' sfx]) ;
[opts, varargin] = vl_argparse(opts, varargin) ;

opts.numFetchThreads = 12 ;
opts.lite = false ;
%opts.imdbPath = fullfile(opts.expDir, 'imdb.mat');
opts.imdbPath = fullfile('/home/cad/zyc/chengxu/matconvnet-1.0-beta22bcn/examples/imagenet/data/img-alexnet-bnorm-simplenn/alexnet1224.mat');
opts.train = struct() ;
