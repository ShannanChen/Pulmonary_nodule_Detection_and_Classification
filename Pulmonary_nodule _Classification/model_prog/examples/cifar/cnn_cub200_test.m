...
useGpu = 1;
dataDir ='/home/cad/zyc/shuju/1219/output/fusion_net_data_1230/44/rgb/42/交叉验证/2/all32/';%'/home/cad/zyc/shuju/所有处理的数据形式1208/roundlinshi/五倍交叉验证/sx/1/all/';%'/home/cad/zyc/shuju/所有处理的数据形式1208/linshi/all/'; %'/home/cad/zyc/shuju/1201/precdata/aug1202/all/';
% ����imdb
...
net = load(fullfile('/home/cad/zyc/chengxu/matconvnet-1.0-beta22bcn/data/rgb2-42cifar-nodule', 'net-epoch-301.mat'));  %vd
%net = load('/home/cad/zyc/matconvnet-1.0-beta22/examples/nodule_classfication/data/41三张灰度尺度相00等的/net-epoch-150.mat')
net = net.net;
%net=load('vgg-f')
...
fid = fopen('2-rgb42.txt','wb');
for i = 1 : numel(test_label)
    fprintf('%d/%d\n', i, numel(test_label));
   % impath = fullfile(dataDir, 'data', 'traincomz224', test_img_path(i));
   impath=fullfile('/home/cad/zyc/shuju/1219/output/fusion_net_data_1230/44/rgb/42/交叉验证/2/all32/',test_img_path(i));
    im = imread(impath{1});
    % ��im��ת��Ϊ����������
