...
class DataBowl3Detector(Dataset):
    def __init__(self, data_dir, split_path, config, phase='train', split_comber=None):
        ...
        self.phase = phase
        self.max_stride = config['max_stride']    # zyc #res18   is 16
        self.stride = config['stride']            # zyc #res18   is 4
        ...
        self.filenames = [os.path.join(data_dir, '%s_clean.npy' % idx) for idx in idcs]     ###segment lung
...
class Crop(object):
    def __init__(self, config):
        ...
        self.bound_size = config['bound_size']    #['bound_size'] = 12
...
def select_samples(bbox, anchor, th, oz, oh, ow):
    z, h, w, d = bbox
    max_overlap = min(d, anchor)    #比较d与anchor边长的大小
