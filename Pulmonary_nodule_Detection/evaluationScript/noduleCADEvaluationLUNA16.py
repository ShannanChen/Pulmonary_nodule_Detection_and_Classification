...
def evaluateCAD(seriesUIDs, results_filename, outputDir, allNodules, CADSystemName, maxNumberOfCADMarks=-1,
    ...
    for seriesuid in seriesUIDs:
        ...
        allCandsCAD[seriesuid] = nodules      #######all annation
    ...
    for seriesuid in seriesUIDs:
        ...
        try:
            noduleAnnots = allNodules[seriesuid]    ######GT
        except KeyError:
            noduleAnnots = []
    ...
    print(frvvlu/7, nxth)
    print(sens_itp[fps_itp==0.125],sens_itp[fps_itp==8])
    if performBootstrapping:
...
if __name__ == '__main__':
    ...
    results_filename = './incep-res.csv'#3D Faster R-CNN - Res18.csv' #top5.csv'#
